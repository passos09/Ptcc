...
🤟 Gestos (Libras) → Texto
A pessoa surda se comunica por Libras, e uma câmera capta os movimentos, convertendo os gestos em texto que o atendente consegue entender.
...
Pensada para uso em locais como recepção de hospital, com foco em agilidade e clareza.
